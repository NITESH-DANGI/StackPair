// Premium minimal SVG icons for StackPair
// Thin stroke, clean lines, consistent sizing
...
export function LeetCodeIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M16 3H8l-4 8 4 8h8l4-8-4-8z"/>
      <path d="M8 12h8"/>
      <path d="M10 9h4"/>
      <path d="M10 15h4"/>
    </svg>
...
export function HandshakeIcon({ className = '', size = 20 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="m6.7 12.4.9-.9a3 3 0 0 1 2.3-.9h.1"/>
      <path d="M2 12h2.5"/>
      <path d="M19.5 12H22"/>
      <path d="m2 12 4.5-4.5L10 4"/>
      <path d="m22 12-4.5-4.5L14 4"/>
    </svg>
  );
}
...
export function PartyIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M15 2h.01"/>
      <path d="M22 20h.01"/>
      <path d="m22 2-2.24.75a2.9 2.9 0 0 0-1.96 3.12v.01c.09.6-.032 1.216-.363 1.727a2.896 2.896 0 0 1-4.556.453l-.01-.01"/>
      <path d="m22 13-.9-.3a2.89 2.89 0 0 0-3.66 1.81v.01c-.2.58-.59 1.07-1.1 1.4a2.9 2.9 0 0 1-4.09-1.4l-.01-.01"/>
    </svg>
  );
}
