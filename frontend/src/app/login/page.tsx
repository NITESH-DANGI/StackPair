        ...
        >
          <div className="card-elevated p-8 sm:p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="login-email" className="block text-sm font-medium text-[#4B5563] mb-1.5">
                  Email address
                </label>
                ...
                {error && (
                  <p id="login-email-error" className="mt-1.5 text-sm text-[#DC2626]">{error}</p>
                )}
              </div>
          ...
          <p className="text-center mt-6 text-sm text-[#6B7280]">
            New here?{' '}
            <Link href="/signup" className="text-[#7A8EC0] font-medium hover:text-[#6A7EB0] transition-colors">
              Create an account
            </Link>
          </p>
        </motion.div>
